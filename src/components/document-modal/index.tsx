...
function DocumentModal() {
  ...
  return (
    <div className="fixed left-1/2 top-1/2 z-10 m-auto h-5/6 w-5/6 -translate-x-1/2 -translate-y-1/2 rounded-md border-2 border-accent bg-base-100 shadow-lg">
      <div className="flex h-full flex-col items-center justify-center">
        ...
        <Link
          className="btn btn-primary btn-outline mx-auto mb-4 mt-auto"
          to="./"
          relative="path"
        >
          Close
